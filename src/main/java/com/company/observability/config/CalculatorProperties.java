 ...
 *       (env-invariant, defined once in {@code application.yml}).</li>
 *   <li>{@code runNumberAware} — aliases of run-number-aware calculators (env-invariant,
 *       defined once in {@code application.yml}). Membership declares the calculator as
 *       runNumber-aware; uses the same alias keys as {@code regions}/{@code runTypes}, never
 *       the real {@code calculator_name}.</li>
 * </ul>
 *
...
public class CalculatorProperties {
    ...
    private List<String> runNumberAware = new ArrayList<>();
}
